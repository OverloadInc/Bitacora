...
/**
 * <code>About</code> class implements a <code>JFrame</code> with the <code>Bitacora</code>
...
public class About extends JFrame {
    ...
    private void initComponents() {
        ...
        //lblLogo.setIcon(new ImageIcon(getClass().getResource("/over/resources/img/bitacora_about.png")));
